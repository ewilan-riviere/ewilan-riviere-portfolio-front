      ...
      <div class="flex flex-wrap order-first text-center md:text-left">
        ...
        <div class="">
          ...
          >
            ...
            />
            <button
              class="inline-flex flex-shrink-0 px-6 py-2 text-white bg-indigo-500 border-0 rounded lg:mt-2 xl:mt-0 focus:outline-none hover:bg-indigo-600"
            >
              Button
            </button>
          </div>
          <p class="mt-2 text-sm text-center text-gray-500 md:text-left">
