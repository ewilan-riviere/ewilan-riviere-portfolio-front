  ...
  <section class="text-gray-700 body-font">
    <div class="container flex flex-wrap px-5 py-24 mx-auto">
      <div class="mx-auto lg:w-2/3">
        <div
          class="relative flex flex-wrap w-full px-10 py-32 mb-4 bg-gray-100"
        >
          <img
            alt="gallery"
            class="absolute inset-0 block object-cover object-center w-full h-full opacity-25"
        ...
        <div class="flex flex-wrap -mx-2">
          <div class="w-1/2 px-2">
            <div
              class="relative flex flex-wrap w-full px-6 py-16 bg-gray-100 sm:py-24 sm:px-10"
            >
              <img
                alt="gallery"
                class="absolute inset-0 block object-cover object-center w-full h-full opacity-25"
